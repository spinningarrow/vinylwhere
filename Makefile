...
dump/all.json: dump/theanalogvault.com/all.json dump/roxydischouse.com/all.json dump/www.vinylrecords.sg/all.json
	jq 'flatten' -s (scripts/theanalogvault.com.js ../dump/theanalogvault.com/all.json | psub) (scripts/roxydischouse.com.js ../dump/roxydischouse.com/all.json | psub) (scripts/www.vinylrecords.sg.js ../dump/www.vinylrecords.sg/all.json | psub) > dump/all.json
...
upload: records.grouped.json.gz
	aws s3 cp s3://vinylwhere/records.grouped.json.gz s3://vinylwhere/records.grouped.json.gz.(date "+%Y%m%d%H%M%S")
	aws s3 cp --acl=public-read --content-type=application/json --content-encoding=gzip records.grouped.json.gz s3://vinylwhere/
